...
namespace Elite
{
	...
	public:
		...
		std::vector<GraphNode*> FindPath(GraphNode* pStartNode, const GraphNode* pEndNode) const;

	private:
		float GetHeuristicCost(const GraphNode* pStartNode, const GraphNode* pEndNode) const;
